...
<!-- Modal Login -->
<div id="loginModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm hidden z-50">
    <div class="bg-white p-6 rounded-lg shadow-lg w-96 text-center">
        ...
        <div class="flex justify-center gap-4">
            ...
            <button onclick="cancelLogin()" class="bg-gray-400 text-white px-4 py-2 rounded hover:bg-gray-500">Batal</button>
        </div>
    </div>
</div>
