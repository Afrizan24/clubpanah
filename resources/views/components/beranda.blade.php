...
<section id="contact" class="bg-gray-800 dark:bg-gray-800 py-12">
    <div class="container mx-auto px-4 max-w-screen-xl">
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
                <h2
                    class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-4xl text-center lg:text-left">
                    Contact Person
                </h2>
                <p
                    class="mb-8 lg:mb-12 font-light text-center lg:text-left text-gray-500 dark:text-gray-400 sm:text-xl">
                    Kami siap membantu Anda. Kirim pesan atau pertanyaan Anda melalui formulir berikut.
                </p>
                <form action="#" class="space-y-8">
                    <div>
                        <label for="name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama Anda</label>
                    ...
                    <div>
                        <label for="email"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Email Anda</label>
            ...
            <div class="flex flex-col justify-center">
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 shadow-inner">
                    ...
                    <ul class="space-y-2 text-gray-700 dark:text-gray-300 text-lg">
                        ...
                        <li>
                            📌 <a href="{{ $beranda->google_maps ?? 'Belum Tersedia' }} " target="_blank"
                    ...
                    <div class="mt-6">
                        @if (!empty($embedUrl))
                            <iframe src="{{ $embedUrl }}" width="100%" height="300" style="border:0;"
