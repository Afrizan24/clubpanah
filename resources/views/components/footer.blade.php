  ...
  <div class="max-w-screen-xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
    <div class="flex flex-col sm:flex-row justify-between items-center">
      <div class="text-center sm:text-left mb-4 sm:mb-0">
        <h3 class="text-xl font-bold">Gold Archery Samarinda</h3>
        <p class="text-sm text-gray-400">Menumbuhkan semangat, membidik prestasi.</p>
      </div>
    ...
    <div class="mt-8 border-t border-gray-700 pt-4 text-center text-sm text-gray-500">
      &copy; {{ date('Y') }} Gold Archery Samarinda. All rights reserved.
    </div>
  </div>
</footer>
