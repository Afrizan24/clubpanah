<section class="bg-gradient-to-r mt-20 from-amber-300 to-yellow-500">
    <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="flex gap-3 mb-8 mt-6 flex-wrap scroll-smooth">
            <a href="#ketua"
                class="px-4 py-2 rounded border border-yellow-400 text-black hover:bg-yellow-500 hover:text-white transition">Ketua
                | Seketaris | Bendahara</a>
            <a href="#anggota"
                class="px-4 py-2 rounded border border-yellow-400 text-black hover:bg-yellow-500 hover:text-white transition">Anggota</a>
        </div>
                            ...
                            <div
                                ...
                                @if ($item->foto)
                                    <img src="{{ Storage::url($item->foto) }}" alt="{{ $item->nama }}"
                                        class="h-48 w-full object-cover rounded-t-xl group-hover:scale-105 transition-transform duration-300">
                                @endif
            ...
            <div id="ketua" class="mt-10">
                <ul class="flex justify-center">
                    <li>
                        <div
                            class="group block rounded-xl shadow-md hover:shadow-lg transition-all duration-300 max-w-[200px] mx-auto">
                            <img src="{{ Storage::url($ketua->foto) }}" alt="Ketua"
                                class="h-48 w-full object-cover rounded-t-xl group-hover:scale-105 transition-transform duration-300">
                            <div class="p-3 text-center">
            ...
            <div id="sekretaris-bendahara" class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 justify-items-center">
                @if (isset($sekretaris) && $sekretaris->foto)
                    <div>
                        <div
                            ...
                            <img src="{{ Storage::url($sekretaris->foto) }}" alt="Sekretaris"
                                class="h-48 w-full object-cover rounded-t-xl group-hover:scale-105 transition-transform duration-300">
                            <div class="p-3 text-center">
                ...
                @if (isset($bendahara) && $bendahara->foto)
                    <div>
                        <div
                            class="group block rounded-xl shadow-md hover:shadow-lg transition-all duration-300 max-w-[250px] mx-auto">
                            <img src="{{ Storage::url($bendahara->foto) }}" alt="Bendahara"
                                class="h-48 w-full object-cover rounded-t-xl group-hover:scale-105 transition-transform duration-300">
                            <div class="p-3 text-center">
