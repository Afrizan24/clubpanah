  ...
  <div class="max-w-7xl mx-auto px-4 flex items-center justify-between">
    ...
    <a href="/" class="flex items-center space-x-4 group">
      ...
      <div class="relative whitespace-nowrap">
        <h1 class="text-white text-base md:text-xl font-bold group-hover:text-yellow-400 transition-colors duration-300">
    ...
    <div class="hidden md:flex space-x-6">
      ...
      <a href="/informasidanlayanan" class="bg-yellow-600 hover:bg-yellow-700 text-white px-4 py-2 rounded transition">
